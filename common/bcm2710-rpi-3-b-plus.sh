...
do_3bp_dtb() {
# now create dts file
cat > /boot/bcm2710-rpi-3-b-plus.dts <<EOF
/dts-v1/;
...
/ {
	...
	__overrides__ {
		...
		cam0-led;
		cache_line_size;
		uart0 = [ 00 00 00 1c 73 74 61 74 75 73 00 ];
		uart1 = [ 00 00 00 1d 73 74 61 74 75 73 00 ];
		i2s = [ 00 00 00 1e 73 74 61 74 75 73 00 ];
		spi = [ 00 00 00 1f 73 74 61 74 75 73 00 ];
		i2c0 = "\0\0\0 status";
		i2c1 = "\0\0\0!status";
		...
		eee = "\0\0\0-microchip,eee-enabled?";
		tx_lpi_timer = "\0\0\0-microchip,tx-lpi-timer:0";
		eth_led0 = "\0\0\0-microchip,led-modes:0";
		eth_led1 = "\0\0\0-microchip,led-modes:4";
		eth_downshift_after = "\0\0\0-microchip,downshift-after:0";
		eth_max_speed = "\0\0\0-max-speed:0";
